...
int main(int argc, char * argv[]){
    ...
    /*
    //Vamos a tener que sobrecargar el operator << y el operator >>. (hay un ejemplo en el tda racional)
    istream & operator>>(istream &is. miTDA & t){
      is >> nombre.getLine(is, nombre);
      while(){
              
      }
    }

    ostream &operator<<(ostream &os, const MiTDA &t){
        os >>
    }
